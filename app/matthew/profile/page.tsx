    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
      ...
      <main style={{ maxWidth: 600, margin: '0 auto', padding: '28px 20px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 800, color: '#1D1B26', letterSpacing: '-0.8px', marginBottom: 4 }}>Matthew</div>
          <div style={{ fontSize: 13, color: '#9E9BB0', marginBottom: 8 }}>Spring Valley High School · Class of 2026</div>
          <div style={{ display: 'flex', gap: 8 }}>
            <div style={{ padding: '4px 12px', borderRadius: 999, background: '#EDE9F7', fontSize: 11, fontWeight: 700, color: '#7B6FA0' }}>Pre-Dental</div>
            <div style={{ padding: '4px 12px', borderRadius: 999, background: '#EDE9F7', fontSize: 11, fontWeight: 700, color: '#7B6FA0' }}>WVU School of Dentistry</div>
          </div>
        </div>
        ...
        <div style={{ background: '#FFFFFF', border: '1.5px solid #E8E5F0', borderRadius: 18, padding: '20px', marginBottom: 16, boxShadow: '0 1px 6px rgba(29,27,38,0.06)' }}>
          <div style={{ fontSize: 15, fontWeight: 800, color: '#1D1B26', marginBottom: 6 }}>WVU School of Dentistry</div>
          <div style={{ fontSize: 13, color: '#9E9BB0', lineHeight: 1.6 }}>DAT prep aligned. AP Physics 2, AP Bio, and AP Chem on deck for senior year.</div>
        </div>
