            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2 }}>
                ...
                {Array.from({ length: daysInMon }).map((_, i) => {
                  ...
                  return (
                    <div key={day} onClick={() => router.push('/matthew/calendar')} style={{ textAlign: 'center', padding: '4px 2px', borderRadius: 8, cursor: 'pointer', background: isToday ? color : 'transparent' }}>
