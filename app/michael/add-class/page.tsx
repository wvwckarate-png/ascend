        ...
        {!showPreview ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={cardStyle}>
              ...
              <div onClick={() => document.getElementById('syllabus-michael')?.click()} style={{ padding: '20px', borderRadius: 12, border: `2px dashed ${file ? color : '#E8E5F0'}`, background: file ? light : '#FAFAF8', textAlign: 'center', cursor: 'pointer' }}>
                ...
                <input id="syllabus-michael" type="file" accept=".pdf" style={{ display: 'none' }} onChange={e => { setFile(e.target.files?.[0] || null); setShowPreview(false); setParsed(null); }} />
              </div>
