    ...
    <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
      ...
      <main style={{ maxWidth: 600, margin: '0 auto', padding: '28px 20px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontSize: 28, fontWeight: 800, color: '#1D1B26', letterSpacing: '-0.8px', marginBottom: 4 }}>Michael</div>
          <div style={{ fontSize: 13, color: '#9E9BB0', marginBottom: 8 }}>9th Grade · Class of 2028</div>
        ...
        <div style={{ background: '#FFFFFF', border: '1.5px solid #E8E5F0', borderRadius: 18, padding: '20px', marginBottom: 16, boxShadow: '0 1px 6px rgba(29,27,38,0.06)' }}>
          ...
          <div style={{ fontSize: 13, color: '#9E9BB0', lineHeight: 1.6 }}>Building the foundation now. MCAT prep starts early — every concept counts.</div>
        </div>
