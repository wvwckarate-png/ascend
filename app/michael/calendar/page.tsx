            ...
            <div style={{ background: '#FFFFFF', border: '1.5px solid #E8E5F0', borderRadius: 18, padding: '16px', marginBottom: 16, boxShadow: '0 1px 6px rgba(29,27,38,0.06)' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2 }}>
                ...
                {Array.from({ length: getDaysInMonth(currentYear, currentMonth) }).map((_, i) => {
                  ...
                  return (
                    <div key={day} onClick={() => { setSelectedDate(dateStr); setView('day'); }} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '6px 2px', borderRadius: 10, cursor: 'pointer', background: isSelected ? '#7B6FA0' : isToday ? '#EDE9F7' : 'transparent' }}>
        ...
        {view === 'day' && (
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
              ...
              <button onClick={() => setShowAdd(true)} style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '7px 14px', borderRadius: 999, border: 'none', background: '#7B6FA0', color: 'white', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'var(--font-jakarta)' }}>
                + Add Task
              </button>
            </div>
            {showAdd && (
              <div style={{ background: '#FFFFFF', border: '1.5px solid #E8E5F0', borderRadius: 16, padding: '16px', marginBottom: 14, boxShadow: '0 1px 6px rgba(29,27,38,0.06)' }}>
                ...
                <input value={newTitle} onChange={e => setNewTitle(e.target.value)} onKeyDown={e => { if (e.key === 'Enter') addTask(); }} placeholder="Task name..." autoFocus style={{ ...inputStyle, marginBottom: 8 }} />
