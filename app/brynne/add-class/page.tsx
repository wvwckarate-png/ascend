      ...
      <main style={{ maxWidth: 600, margin: '0 auto', padding: '28px 20px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={cardStyle}>
            ...
            <div onClick={() => document.getElementById('syllabus-brynne')?.click()} style={{ padding: '24px', borderRadius: 12, border: '2px dashed #E8E5F0', background: '#FAFAF8', textAlign: 'center', cursor: 'pointer' }}>
          ...
          <button onClick={handleSubmit} disabled={!className || !semester || loading} style={{ padding: '14px', borderRadius: 14, border: 'none', background: '#E8956D', color: 'white', fontSize: 14, fontWeight: 800, cursor: 'pointer', fontFamily: 'var(--font-jakarta)', opacity: !className || !semester || loading ? 0.4 : 1 }}>
