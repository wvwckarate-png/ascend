...
function IconCheckCircle({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none">
      <circle cx="14" cy="14" r="11" stroke="#E8956D" strokeWidth="1.6" fill="#FFF3E8"/>
      <path d="M9 14l3.5 3.5 6.5-6.5" stroke="#E8956D" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
