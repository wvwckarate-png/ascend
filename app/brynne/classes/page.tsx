  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '28px 20px 80px' }}>
        ...
        <div style={{ fontSize: 28, fontWeight: 800, color: '#1D1B26', letterSpacing: '-0.8px', marginBottom: 24 }}>Brynne's Classes 🐉</div>
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: 12 }}>
            {classes.map((cls) => (
              <div
                ...
                onMouseEnter={e => {
                  ...
                  (e.currentTarget as HTMLDivElement).style.boxShadow = '0 6px 20px rgba(232,149,109,0.15)';
                }}
                onMouseLeave={e => {
              ...
              >
                <div style={{ width: 40, height: 40, borderRadius: 11, background: cls.color + '22', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 14, fontSize: 12, fontWeight: 800, color: cls.color }}>
                  {classLabel(cls.name)}
                </div>
            ...
            >
              <div style={{ width: 40, height: 40, borderRadius: 11, background: '#FFF3E8', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 14, fontSize: 20, color: '#E8956D' }}>+</div>
