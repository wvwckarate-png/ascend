...
- Pick the layout that makes the content clearest — don't force structure that doesn't fit`;
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      await supabase.from('study_guides').insert({ student_id: 'brynne', title: guideName.trim(), content: studyGuide, source_filename: sourceFiles.join(', ') || 'Custom', folder_id: selectedFolderId || folderId || null });
